...
df = pd.read_excel('./electromech-conversion/MagCurve.xlsx')
MMF = df['MMF'].values
Fluxo = df['Fluxo'].values

# Parâmetros do núcleo (exemplo)
l_c = 0.5  # Comprimento do núcleo em metros
A_nucleo = 0.1732  # Área do núcleo em m² (ajuste conforme Desafio 1)
...
N_p = 300  # Valor de espiras do Desafio 1
...
V_p = 120  # Tensão primária (Desafio 1)
